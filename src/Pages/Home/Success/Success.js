...
const Success = () => {
    return (
        <div className='bg-zinc-600 w-10/12 mx-auto mt-12 pt-4 pb-8 rounded-lg'>
            <h1 className='text-center text-emerald-400 text-3xl font-semibold'>Successful Clients</h1>
            <p className='text-center text-white w-3/4 mx-auto mt-4'>These are my most successful clients living abroad now. By taking the services it was much easier for them to migrate to other countries.</p>
            <div className='w-5/6 mx-auto mt-8 grid grid-cols-2 gap-8'>
                <div>
                    <Card
